...
public class TelephoneController {
  @Autowired private TelephonesDao telephonesDao;
  ...
  public ResponseEntity<Telephones> getTelephoneById(
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<List<Telephones>> searchTelephonesByName(
      @ApiIgnore @ModelAttribute SearchCriteria search) {
    List<Telephones> searchResult =
        telephonesDao.searchByNameAndSurname(
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<List<Telephones>> searchTelephonesByNumber(
      @ApiIgnore @ModelAttribute SearchCriteria search) {
    List<Telephones> searchResult =
