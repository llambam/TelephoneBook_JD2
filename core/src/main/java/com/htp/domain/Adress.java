...
public class Adress {
    ...
    public Adress(Long adressId, String country, String city, String street, String houseNumber, Long floor, Long apartmentNumber, Long userId, Long telId, Integer adressBlock, boolean userAdress) {
        this.adressId = adressId;
        this.country = country;
        this.city = city;
        this.street = street;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(adressId, country, city, street, houseNumber, floor, apartmentNumber, userId, telId, adressBlock, userAdress);
    }
}
