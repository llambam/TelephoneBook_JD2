...
public class HAdress {
    ...
    private HTelephones hTelephones;
    ...
    public HAdress(String country, String city, String street, String houseNumber, Long floor, Long apartmentNumber, HUser user, HTelephones hTelephones, Integer adressBlock, boolean userAdress) {
    ...
    public HTelephones gethTelephones() {
        return hTelephones;
    }

    public void sethTelephones(HTelephones hTelephones) {
        this.hTelephones = hTelephones;
    }
    ...
    public boolean equals(Object o) {
        ...
        return userAdress == hAdress.userAdress &&
                ...
                Objects.equals(hTelephones, hAdress.hTelephones) &&
                Objects.equals(adressBlock, hAdress.adressBlock);
    }

    @Override
    public int hashCode() {
        return Objects.hash(adressId, country, city, street, houseNumber, floor, apartmentNumber, user, hTelephones, adressBlock, userAdress);
    }
}
